...
from cortex.gui.canvas import GraphScene, GraphView
from cortex.gui.panels.property_panel import PropertyPanel
from cortex.gui.panels.log_panel import LogPanel

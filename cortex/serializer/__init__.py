...
=============================================================================
 SERIALIZER MODULE
=============================================================================
This module acts as the "Save/Load Engine" for the Cortex. 
...
Key Features:
1. Supports multiple formats: `.cortex` (which is technically YAML), `.yaml`, and `.json`.
...
from .constants import CORTEX_EXTENSION, SCHEMA_VERSION
